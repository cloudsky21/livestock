...
// Update application form pdf
  ...
  //do the error checking and upload if the check comes back OK
	...
	<head>
		...
		<link rel="stylesheet" href="bootswatch/solar/bootstrap.css">
				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="myNavbar">
						<ul class="nav navbar-nav">
							<li><a href="farmers"><span class="glyphicon glyphicon-user"></span>  Farmers</a></li>						
						...
						<ul class="nav navbar-nav navbar-right">
							<li><a href="#" data-toggle="modal" data-target="#myModal" data-backdrop="static" data-keyboard="false">
	...
	<div class="modal fade" id="ids" role="dialog">
					...
					<div class="modal-body">
						<form method="POST" action="" class="form-horizontal" autocomplete="false">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<textarea name="loading" id ="loading" tabindex="13" class="form-control"></textarea>
								</div>
							</div>
							<div class="form-group">
		...
		<form class="modal multi-step form-horizontal" id="demo-modal-1">
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					...
					<div class="modal-body step step-1">
						<!---This is step 1. -->
						<div class="form-group">
							<label class="control-label col-xs-2" for="groupies">GROUP NAME</label>
							<div class="col-xs-10">
								<input type="text" name="groupies" id="groupies" class="form-control" tabindex="1">
							</div>
						</div>

						<div class="form-group">
							<label class="control-label col-xs-2" for="proponent">PROPONENT</label>
							<div class="col-xs-10">
								<input type="text" name="proponent" id="proponent" class="form-control" tabindex="2">
							</div>
						</div>

						<div class="form-group">
							<label class="control-label col-xs-2" for="program">PROGRAM</label>
							<div class="col-xs-10">
								<input type="text" name="program" id="program" class="form-control" value="RSBSA" readonly></td>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-xs-10">
								...
								<select id="peo" name="peo" class="form-control login" onchange="address(this.value);" tabindex="3">
									<option value="all">All</option>
									<option value="PEO Biliran">Biliran</option>
									<option value="PEO Ormoc">Ormoc</option>
									<option value="Leyte1-2">Leyte 1 and 2</option>
									<option value="PEO Abuyog">Abuyog</option>
									<option value="PEO Sogod">Sogod</option>
									<option value="PEO W-Samar">Western Samar</option>
									<option value="PEO E-Samar">Eastern Samar</option>
									<option value="PEO N-Samar">Northern Samar</option>
								</select>
							</div>
						</div>								
						<div class="form-group">								
							<label class="col-xs-2 control-label sr-only" for="townbrgy">Town with Barangay</label>					
							<div class="col-xs-10">
								<select id="townbrgy" name="townbrgy" class="form-control" tabindex="4">
					...
					<div class="modal-body step step-2">
						...
						<div class="form-group">
							<label for="animal" class="control-label col-xs-2">Kind of Animal: </label>
							<div class="col-xs-10">	
								<select name="animal" id="animal-type" onchange="typeAnimal(this.value);" class="form-control" tabindex="5">
						...
						<div class="form-group">
							...
							<div class="col-xs-10">	
								<select name="purpose" id="purpose" class="form-control" tabindex="6">
									<option value="---">----</option>
						...
						<div class="form-group">
							<label for="date_from" class="control-label col-xs-2">Start of Cover</label>
							<div class="col-xs-10">
								<input type="date" name="date_from" id="date_from" class="form-control" tabindex="7">
							</div>
						</div>

						<div class="form-group">	
							<label for="date_to" class="control-label col-xs-2">End of Cover</label>		
							<div class="col-xs-10">
								<input type="date" name="date_to" id="date_to" class="form-control" tabindex="8">
							</div>

						</div>

						<div class="form-group">	
							<label for="sum_insured" class="control-label col-xs-2">Total Sum Insured</label>		
							<div class="col-xs-10">
								<input type="number" name="sum_insured" id="sum_insured" class="form-control" min="0" step="any" tabindex="9">
							</div>

						</div>

						<div class="form-group">	
							<label for="prate" class="control-label col-xs-2">Rate</label>		
							<div class="col-xs-10">
								<input type="number" name="prate" id="prate" class="form-control" min="0" step="any" tabindex="10">
							</div>

						</div>

						<div class="form-group">	
							<label for="premiumloading" class="control-label col-xs-2">Add. Premium Loading</label>		
							<div class="col-xs-10">
								<textarea name="premiumloading" class="form-control" tabindex="11"></textarea>
							</div>
					...
					<div class="modal-body step step-3">
						...
						<div class="form-group">
							<label class="control-label col-xs-2">Add Farmers</label>
							<div class="col-xs-10">
								<button type="button" class=" btn btn-success" data-target="#ids" data-toggle="modal" data-backdrop="static" data-keyboard="false"><span class="glyphicon glyphicon-plus"></span></button>
							</div>
						</div>
						<table class="table table-striped sm-font">
							<thead>
								<tr>
									<th>ID</th>
									<th>FARMERS</th>
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
						<button type="button" class="btn btn-warning step-2" data-step="1" onclick="sendEvent('#demo-modal-1', 1)">Back</button>
						<button type="button" class="btn btn-success step step-1" data-step="1" onclick="sendEvent('#demo-modal-1', 2)">Continue</button>
						<button type="button" class="btn btn-warning step step-3" data-step="2" onclick="sendEvent('#demo-modal-1', 2)">Back</button>
						<button type="button" class="btn btn-success step step-2" data-step="2" onclick="sendEvent('#demo-modal-1', 3)">Continue</button>
						<button type="submit" class="btn btn-primary step-3" data-step="3">Save</button>
					</div>
				</div>
			</div>
		</form>
		<script src="bootstrap-3.3.7-dist/js/multi-step-modal.js"></script>
		<script>
