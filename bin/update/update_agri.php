		...
		<tr>
			...
			<td>
                <select id="type_agri" name="type_agri" class="form-control form-control-sm">
                    <option value="AGRI" <?php if($nonersbsa_type == 'AGRI') { echo "selected"; } ?>>Default</option>
                    <option value="AGRI-ARB" <?php if($nonersbsa_type == 'AGRI-ARB') { echo "selected"; } ?>>DAR</option>
                </select>
            </td>
		</tr>
		<tr>
