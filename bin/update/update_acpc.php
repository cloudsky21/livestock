...
<table class="table table-sm table-condensed">
	...
	<tr>
		...
		<td>
			<select id="animal-type" name="animal-type" id="animal-type" onchange="getch(this.value);" class="form-control form-control-sm" readonly>
		<option value="--------">---------</option>
	...
	<?php if(!empty($application_form) && file_exists('uploads/ACPC/'.$ids.'ACPC.pdf')) {echo '<small>Application file already exists.</small>';} else {} ?>
			</td>
	</tr>
	<tr>
		<th scope="row">
...
<table class="table table-sm table-condensed">
	...
	<tr>
		...
		<td>
			<select id="animal-type" name="animal-type" id="animal-type" onchange="getch(this.value);" class="form-control form-control-sm">
		<option value="--------">---------</option>
		<option value="Carabao-Breeder"<?PHP if($kAnimal== "Carabao-Breeder") echo "selected" ?>>Carabao Breeder</option>
		<option value="Carabao-Draft"<?PHP if($kAnimal== "Carabao-Draft") echo "selected" ?>>Carabao Draft</option>
		<option value="Carabao-Dairy"<?PHP if($kAnimal== "Carabao-Dairy") echo "selected" ?>>Carabao Dairy</option>
