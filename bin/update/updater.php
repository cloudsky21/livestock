...
if ($stats == 'evaluated') {
	...
	<tr>
		...
		<td>
			...
			echo '<input type="number" readonly id="lslb" name="lslb" step="any" min=0 class="form-control form-control-sm" value="' . $logbook . '" autofocus>';
		} else {
			echo '<input type="number" readonly id="lslb" name="lslb" step="any" min=0 class="form-control form-control-sm" autofocus>';
		} ?>
			</td>
	</tr>	
...
<tr>
<th scope="row"><label for="group-name">Group Name / Lending Institution</label></th>
<td>
<input type="text" id="group-name" name="group-name" placeholder="DA/LGU or et. al." required maxlength="200" value="<?PHP echo $group; ?>" class="form-control form-control-sm" readonly >
</td>	
</tr>
...
<th scope="row"><label for="assured-name">Name of Assured</label></th>
	<td>
	<input type="text" id="assured-name" name="assured-name" id="assured-name" placeholder="Juan Dela Cruz et. al." required maxlength="200" value="<?PHP echo $assured; ?>"  class="form-control form-control-sm" readonly >
	</td>
	</tr>
...
<td>	
	<select id="province" name="province" placeholder="Leyte" class="form-control form-control-sm" readonly >
		<option value="Leyte" 
		<?php if ($province == "LEYTE") {
		echo "selected";
	} ?>>LEYTE</option>
		<option value="Southern Leyte" 
		<?php if ($province == "SOUTHERN LEYTE") {
		echo "selected";
	} ?>>SOUTHERN LEYTE</option>
		<option value="Biliran" 
		<?php if ($province == "BILIRAN") {
		echo "selected";
	} ?>>BILIRAN</option>
		<option value="Northern Samar" 
		<?php if ($province == "NORTHERN SAMAR") {
		echo "selected";
	} ?>>NORTHERN SAMAR</option>
		<option value="Eastern Samar" 
		<?php if ($province == "EASTERN SAMAR") {
		echo "selected";
	} ?>>EASTERN SAMAR</option>
		<option value="Western Samar" 
		<?php if ($province == "WESTERN SAMAR") {
		echo "selected";
...
<tr>
	...
	<td>
	<input type="text" id="town" name="town" placeholder="Abuyoge" required maxlength="200"  value="<?PHP echo $town; ?>" class="form-control form-control-sm" readonly>
	</td>
</tr>	
...
<th scope="row">
	...
	<td>
		<select name="animal-type" id="animal-type" onchange="getch(this.value);" class="form-control form-control-sm" readonly>
			<option value="--------">---------</option>
			...
			<option value="Goat-Milking"<?PHP if ($kAnimal == "Goat-Milking") echo "selected" ?>>Goat Milking</option>
			<option value="--------">---------</option>
...
<th scope="row">	
	...
	<td>
		<input type="number" min=0 step="any" name ="rate" id ="rate" required value="<?PHP echo $rate; ?>" placeholder="0.00" class="form-control form-control-sm" readonly>
	</td>
</tr>	
...
<th scope="row">	
	<label for="effectivity-date">FROM:</label>
		...
		<td>
		<input type="date" name="effectivity-date"  value="<?PHP echo $from; ?>" class="form-control form-control-sm" readonly>
		</td>	
</tr>
...
<th scope="row">
	...
	<td>	
	<input type="date" name="expiry-date"  value="<?PHP echo $to; ?>" class="form-control form-control-sm" readonly>
	</td>
...
<th scope="row">
	...
	<td>	
		<input type="number" id="rcnum" name="rcnum" tabindex="2" placeholder="0000000" value="<?PHP echo $rcNumber; ?>" required step="any" class="form-control form-control-sm" readonly>
		</td>
...
<th scope="row">
	...
	<td>	
		<input type="number" id="rcAmt" name="rcAmt" tabindex="3" placeholder="0000" value="<?PHP echo $rcAmount; ?>" required step="any" class="form-control form-control-sm" readonly>
		</td>	
</tr>
...
<th scope="row">
		<label for="scharge">Service Charge</label>
			...
			<td>
			<input type="number" id="scharge" name="scharge" tabindex="4" placeholder="0000" value="<?PHP echo $s_charge; ?>" step="any" class="form-control form-control-sm" readonly>
			</td>		
	</tr>
...
<th scope="row">
		...
		<td>
			...
			<?php if (!empty($application_form) && file_exists('uploads/' . $ids . 'REGULAR.pdf')) {
...
<tr>
		...
		<td>
			<?PHP if (!empty($logbook)) {
			echo '<input type="number"id="lslb" name="lslb" step="any" min=0 class="form-control form-control-sm" value="' . $logbook . '" autofocus>';
		} else {
			echo '<input type="number"id="lslb" name="lslb" step="any" min=0 class="form-control form-control-sm" autofocus>';
		} ?>
			</td>
	</tr>	
...
<th scope="row"><label for="group-name">Group Name / Lending Institution</label></th>
<td>
<input type="text" id="group-name" name="group-name" placeholder="DA/LGU or et. al." required maxlength="200" value="<?PHP echo $group; ?>" class="form-control form-control-sm" >
</td>	
</tr>
...
<th scope="row"><label for="assured-name">Name of Assured</label></th>
	<td>
	<input type="text" id="assured-name" name="assured-name" id="assured-name" placeholder="Juan Dela Cruz et. al." required maxlength="200" value="<?PHP echo $assured; ?>"  class="form-control form-control-sm">
	</td>
	</tr>
...
<td>	
	<select id="province" name="province" placeholder="Leyte" class="form-control form-control-sm">
		<option value="Leyte" 
		<?php if ($province == "LEYTE") {
		echo "selected";
	} ?>>LEYTE</option>
...
<tr>
	<th scope="row"><label for="address">Town</label></th>
	<td>
	<input type="text" id="town" name="town" placeholder="Abuyoge" required maxlength="200"  value="<?PHP echo $town; ?>" class="form-control form-control-sm" >
	</td>
</tr>	
...
<th scope="row">
	...
	<td>
		<select name="animal-type" id="animal-type" onchange="getch(this.value);" class="form-control form-control-sm" >
			<option value="--------">---------</option>
			<option value="Carabao-Breeder"<?PHP if ($kAnimal == "Carabao-Breeder") echo "selected" ?>>Carabao Breeder</option>
			<option value="Carabao-Draft"<?PHP if ($kAnimal == "Carabao-Draft") echo "selected" ?>>Carabao Draft</option>
			<option value="Carabao-Dairy"<?PHP if ($kAnimal == "Carabao-Dairy") echo "selected" ?>>Carabao Dairy</option>
...
<th scope="row">	
	<label for="effectivity-date">FROM:</label>
		...
		<td>
		<input type="date" name="effectivity-date"  value="<?PHP echo $from; ?>" class="form-control form-control-sm" >
		</td>	
</tr>
...
<th scope="row">
	...
	<td>	
	<input type="date" name="expiry-date"  value="<?PHP echo $to; ?>" class="form-control form-control-sm" >
	</td>
...
<th scope="row">
	...
	<td>	
		<input type="number" id="rcnum" name="rcnum" tabindex="2" placeholder="0000000" value="<?PHP echo $rcNumber; ?>" required step="any" class="form-control form-control-sm" >
		</td>
...
<th scope="row">
	...
	<td>	
		<input type="number" id="rcAmt" name="rcAmt" tabindex="3" placeholder="0000" value="<?PHP echo $rcAmount; ?>" required step="any" class="form-control form-control-sm" >
		</td>	
</tr>
...
<th scope="row">
		<label for="scharge">Service Charge</label>
			...
			<td>
			<input type="number" id="scharge" name="scharge" tabindex="4" placeholder="0000" value="<?PHP echo $s_charge; ?>" step="any" class="form-control form-control-sm" >
			</td>		
	</tr>
...
<tr>
	<th scope="row"><input type="hidden" id="ids" name="ids" value="<?PHP echo $ids; ?>" class="form-control form-control-sm"></th>
	<td></td>
