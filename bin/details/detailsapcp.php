...
<table class="table table-condensed table-sm table-hover">
	<tbody>
		...
		<tr>
			...
			<td><?PHP if(file_exists('../uploads/RSBSA/'.$_SESSION['insurance'].'/'.$ids.'RSBSA.pdf')){ echo '<a href="../uploads/RSBSA/'.$_SESSION['insurance'].'/'.$ids.'RSBSA.pdf" download>'.$ids.'.pdf</a><br>';} else { echo "<strong>No File Uploaded</strong>";} ?></td>
		</tr>
		<tr>
