...
<table class="table table-condensed table-sm table-striped">
	<tbody>
		...
		<tr>
			...
			<td class="text-success"><?PHP echo $tag; ?></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><?PHP if(file_exists('../uploads/YRRP/'.$_SESSION['insurance'].'/'.$ids.'YRRP.pdf')){ echo '<a href="../uploads/YRRP/'.$_SESSION['insurance'].'/'.$ids.'YRRP.pdf" download>'.$ids.'.pdf</a><br>';} else { echo "<strong>No File Uploaded</strong>";} ?></td>
		</tr>
		<tr>
