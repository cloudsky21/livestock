...
<table class="table table-condensed table-sm table-hover">
    <tbody>
        ...
        <tr>
            ...
            <td>
                <?PHP echo $rcpt_number; ?>
            </td>
        </tr>
        <tr>
            <th scope="row">Receipt Amount</th>
            <td>
                <?PHP echo number_format($rcpt_amt, 2); ?>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <?PHP if (file_exists('uploads/REGULAR/' . $_SESSION['insurance'] . '/' . $ids . 'REG.pdf')) {
                    echo '<a href="uploads/REGULAR/' . $_SESSION['insurance'] . '/' . $ids . 'REG.pdf" download' . $_SESSION['insurance'] . '/>' . $ids . '.pdf</a><br>';
                } else {
