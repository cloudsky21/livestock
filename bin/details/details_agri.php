...
<table class="table table-condensed table-sm">
	<tbody>
		...
		<tr>
			...
			<td><?PHP if(file_exists('../uploads/AGRIAGRA/'.$_SESSION['insurance'].'/'.$ids.'AGRIAGRA.pdf')){ echo '<a href="../uploads/AGRIAGRA/'.$_SESSION['insurance'].'/'.$ids.'AGRIAGRA.pdf" download>'.$ids.'.pdf</a><br>';} else { echo "<strong>No File Uploaded</strong>";} ?></td>
		</tr>
		<tr>
