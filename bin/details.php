...
<ul class="list-group">
	...
	<li class="list-group-item">
		...
		<p><?PHP if(file_exists('../uploads/RSBSA/'.$_SESSION['insurance'].'/'.$ids.'RSBSA.pdf')){ echo '<a href="../uploads/RSBSA/'.$_SESSION['insurance'].'/'.$ids.'RSBSA.pdf" download>'.$ids.'.pdf</a><br>';} else { echo "<strong>No File Uploaded</strong>";} ?></p>
	</li>
