...
<body>
	...
	<div class="container">
		<p class="col-xs-4">RONELO D. PESQUERA <br><strong>CHIEF, Marketing and Sales Division</strong></p>
		<p class="col-xs-4"><?php echo $prepared ?> <br><strong>Prepared By</strong></p>
		<p class="col-xs-4"><?php echo $iu ?> <br><strong>IU/Solicitor/AT</strong></p>
	</div>
