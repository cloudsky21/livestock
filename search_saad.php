		...
		switch ($str1) {
			...
			foreach($result as $row){
				...
				if ($row['status'] =="active"){
					...
					echo '<td><a class="btn btn-outline-success btn-sm" href="../processingslip?ids='.$row['idsnumber'].'AGRI" target="_blank"><i class="fa fa-file-o"> </i></a></td>';
					...
					echo '<td><a class="btn btn-outline-success btn-sm" href="../processingslip?ids='.$row['idsnumber'].'AGRI" target="_blank"><span class="glyphicon glyphicon-list"> </span></a></td>';
