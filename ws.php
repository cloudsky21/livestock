...
<select name="address" onchange="location = this.value;" class="form-control">
	...
	<option value="ws.php" selected>Western Samar</option>
...
else echo "<li class='previous' style='cursor:pointer'><a href='ws.php?page=".($page-1)."' class='pager'>Previous</a></li>";

if($page < $total_pages){
echo "<li class='next' style='cursor:pointer'><a href='ws.php?page=".($page+1)."' class='pager'>Next</a></li>";
}
else {};
echo '</ul>';
...
<?PHP
	...
	$rs->execute(["%W.S%",$start_from, $results_per_page]);
