	...
	<head>
		...
		<script>
			function address($val){
				...
				if($val == 'Leyte1-2' || $val == 'PEO Ormoc' || $val == 'PEO Abuyog' || $val == 'PEO Hilongos')
				{
					$('#province').val("LEYTE");
				}
				else if($val == 'PEO Biliran')
				{
					$('#province').val("BILIRAN");
				}
				else if($val == 'PEO Sogod')
				{
					$('#province').val("SOUTHERN LEYTE");	
				}
				else if($val == 'PEO W-Samar')
				{
					$('#province').val("WESTERN SAMAR");	
				}
				else if($val == 'PEO E-Samar')
				{
					$('#province').val("EASTERN SAMAR");	
				}
				else if($val == 'PEO N-Samar')
				{
					$('#province').val("NORTHERN SAMAR");	
				}
			}
