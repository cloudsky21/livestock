		...
		switch ($str1) {
			...
			foreach($result as $row){
				...
				if ($row['status'] =="active"){
					...
					if (!$row['lslb']=="0") { echo '<td><a class="btn btn-outline-success btn-sm" href="../policy/policyagriagra?lslb='.$row['lslb'].'" target="_blank">'.$row['lslb'].'</a></td>';}else {echo '<td><a class="btn btn-outline-success btn-sm disabled" href="#">'.$row['lslb'].'</a></td>';}
					echo '<td><a class="btn btn-outline-success btn-sm" href="../printing/processingslip?ids='.$row['idsnumber'].'AGRI" target="_blank"><i class="fa fa-file-o"> </i></a></td>';
					if($server == "127.0.0.1"){	echo '<td><a class="btn btn-outline-warning btn-sm" href="#editModal" id="edit_id" data-toggle="modal" data-id="'.$row['idsnumber'].'" data-backdrop="static"><i class="fa fa-edit"></i></a></td>';		
					echo '<td><a class="btn btn-outline-danger btn-sm" data-target="#deleteModal" id="delete_id" data-toggle="modal" data-id="'.$row['idsnumber'].'" data-backdrop="static"><i class="fa fa-trash-o"></i></a></td>';} else {}
					...
					echo '<td>'.$row['animal'].'</td>';
					echo '<td>'.$row['heads'].'</td>';
					if (!$row['lslb']=="0") { echo '<td><a class="btn btn-outline-success btn-sm" href="../policy/policyagriagra?lslb='.$row['lslb'].'" target="_blank">'.$row['lslb'].'</a></td>';}else {echo '<td><a class="btn btn-outline-primary btn-sm disabled" href="#">'.$row['lslb'].'</a></td>';}
					echo '<td><a class="btn btn-outline-success btn-sm" href="../printing/processingslip?ids='.$row['idsnumber'].'AGRI" target="_blank"><span class="glyphicon glyphicon-list"> </span></a></td>';
					if($server == "127.0.0.1"){	echo '<td><a class="btn btn-outline-warning btn-sm" href="#editModal" id="edit_id" data-toggle="modal" data-id="'.$row['idsnumber'].'" data-backdrop="static"><span class="glyphicon glyphicon-edit"/></span></a></td>';		
					echo '<td><a class="btn btn-outline-danger btn-sm" data-target="#deleteModal" id="delete_id" data-toggle="modal" data-id="'.$row['idsnumber'].'" data-backdrop="static"><span class="glyphicon glyphicon-trash"/></span></a></td>';} else {}
				...
				else if ($row['status'] =="hold")
				{
					...
					if (!$row['lslb']=="0") { echo '<td><a class="btn btn-outline-primary btn-sm" href="../policy/rsbsa?lslb='.$row['lslb'].'" target="_blank">'.$row['lslb'].'</a></td>';}else {echo '<td><a class="btn btn-outline-primary btn-sm disabled"></a></td>';}
				...
				else
				{
					...
					if (!$row['lslb']=="0") { echo '<td><a class="btn btn-success btn-sm" href="../policy/policyagriagra?lslb='.$row['lslb'].'" target="_blank">'.$row['lslb'].'</a></td>';}else {echo '<td><a class="btn btn-success btn-sm disabled" href="#">'.$row['lslb'].'</a></td>';}
			...
			foreach($result as $row){
				...
				if ($row['status'] =="active"){
					...
					echo '<td><a class="btn btn-outline-success btn-sm" href="../processingslip?ids='.$row['idsnumber'].'PPPP" target="_blank"><i class="fa fa-file-o"> </i></a></td>';
					...
					echo '<td>'.$row['heads'].'</td>';
					if (!$row['lslb']=="0") { echo '<td><a class="btn btn-outline-success btn-sm" href="policy.php?lslb='.$row['lslb'].'" target="_blank">'.$row['lslb'].'</a></td>';}else {echo '<td><a class="btn btn-outline-success btn-sm disabled" href="#">'.$row['lslb'].'</a></td>';}
					echo '<td><a class="btn btn-outline-success btn-sm" href="../processingslip?ids='.$row['idsnumber'].'PPPP" target="_blank"><span class="glyphicon glyphicon-list"> </span></a></td>';
					if($server == "127.0.0.1"){	echo '<td><a class="btn btn-outline-warning btn-sm" href="#editModal" id="edit_id" data-toggle="modal" data-id="'.$row['idsnumber'].'" data-backdrop="static"><span class="fa fa-edit"/></span></a></td>';		
					echo '<td><a class="btn btn-outline-danger btn-sm" data-target="#deleteModal" id="delete_id" data-toggle="modal" data-id="'.$row['idsnumber'].'" data-backdrop="static"><span class="fa fa-trash"/></span></a></td>';} else {}
			...
			foreach($result as $row){
				...
				if ($row['status'] =="active"){
					...
					echo '<td><a class="btn btn-outline-success btn-sm" href="../processingslip?ids='.$row['idsnumber'].'PPPP" target="_blank"><span class="fa fa-list"> </span></a></td>';
					if($server == "127.0.0.1"){	echo '<td><a class="btn btn-outline-warning btn-sm" href="#editModal" id="edit_id" data-toggle="modal" data-id="'.$row['idsnumber'].'" data-backdrop="static"><span class="fa fa-edit"/></span></a></td>';		
					echo '<td><a class="btn btn-outline-danger btn-sm" data-target="#deleteModal" id="delete_id" data-toggle="modal" data-id="'.$row['idsnumber'].'" data-backdrop="static"><span class="fa fa-trash"/></span></a></td>';} else {}
