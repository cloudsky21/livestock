...
<select name="address" onchange="location = this.value;" class="form-control">
	...
	<option value="1-2.php" selected>Leyte 1 & 2</option>
...
else echo "<li class='previous' style='cursor:pointer'><a href='1-2.php?page=".($page-1)."' class='pager'>Previous</a></li>";

if($page < $total_pages){
echo "<li class='next' style='cursor:pointer'><a href='1-2.php?page=".($page+1)."' class='pager'>Next</a></li>";
}
else {};
echo '</ul>';
...
<?PHP
	...
	$rs->execute(["%leyte%",$start_from, $results_per_page]);
