...
<select name="address" onchange="location = this.value;" class="form-control">
	...
	<option value="es.php" selected>Eastern Samar</option>
...
else echo "<li class='previous' style='cursor:pointer'><a href='es.php?page=".($page-1)."' class='pager'>Previous</a></li>";

if($page < $total_pages){
echo "<li class='next' style='cursor:pointer'><a href='es.php?page=".($page+1)."' class='pager'>Next</a></li>";
}
else {};
echo '</ul>';
...
<?PHP
	...
	$rs->execute(["%E.S%",$start_from, $results_per_page]);
